...
// ==========================================
// 6. PAINEL SERVIDOR - LISTA DIÁRIA & RELATÓRIO DE IMPRESSÃO
// ==========================================
...
async function imprimirRelatorioGeral() {
    ...
    let htmlFinal = `
        <div class="no-print" style="margin-bottom: 20px; display: flex; gap: 10px;">
            ...
            <button onclick="renderListaServidor()" class="btn-secondary">Voltar à Lista Diária</button>
        </div>
                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <th class="col-processos">Nº Processos (Expandido)</th>
                        </tr>
                    </thead>
                    <tbody>
        `;
